...
@section('meta_description', 'Schedule a consultation with Endow Corporation. Expert consulting in travel, education, technology, and hospital tourism.')
...
<section class="section-gap" style="background-color: var(--color-body-bg);">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-[52px]" data-animate>
            ...
            <h2 class="section-heading">Why Choose <span style="color: var(--color-primary);">Endow Corporation?</span></h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[30px]" data-animate>
            @foreach([
                ['icon' => 'fa-solid fa-earth-americas', 'title' => 'Global Expertise', 'desc' => 'Delivering solutions across 30+ countries.'],
                ['icon' => 'fa-solid fa-bullseye', 'title' => 'Innovative Approach', 'desc' => 'Cutting-edge strategies and modern solutions.'],
                ['icon' => 'fa-solid fa-heart', 'title' => 'Customer-Centric', 'desc' => 'Partnerships focused on your success.'],
                ['icon' => 'fa-solid fa-shield-halved', 'title' => 'Trusted & Secure', 'desc' => 'Enterprise-grade security standards.'],
            ] as $index => $f)
                <div data-animate class="service-card text-center">
                    <div class="service-icon mx-auto mb-5">
                        <i class="{{ $f['icon'] }}"></i>
                    </div>
                    <h3 class="text-lg font-semibold mb-2" style="color: var(--color-text-heading);">{{ $f['title'] }}</h3>
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div data-animate>
                ...
                <p class="text-white/60 text-base leading-relaxed mb-10">Ready to take the next step? Let's connect! Our team is here to help with Travel, Education, Technology, or Healthcare consulting.</p>
                <div class="space-y-6">
