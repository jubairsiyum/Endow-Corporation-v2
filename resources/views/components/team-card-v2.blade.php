<div class="team-centered-card group w-[220px] flex-shrink-0">
    <div class="rounded-2xl overflow-hidden bg-white h-full flex flex-col transition-all duration-300 hover:-translate-y-1.5"
        ...
        {{-- Photo — B&W, fixed height --}}
        <div class="relative overflow-hidden flex-shrink-0" style="height: 250px;">
        ...
        {{-- Gradient Info Panel --}}
        <div class="px-4 py-4 text-center flex flex-col justify-center flex-1"
